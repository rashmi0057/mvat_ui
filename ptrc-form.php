      ...
      <div id="gst-reg" class="right-content content">
        <h1>PTRC Registration</h1>
              ...
              <form
                ...
                id="vat_registration_id"
                class="vat_registration_cls"
                method="post"
              ...
              >
                <ul id="progressbar">
                  ...
                  <li id="stepActive_2" class="steps">POB</li>
                  <li id="stepActive_3" class="steps">Bank Details</li>
                  <li id="stepActive_4" class="steps">APOB</li>
                  <li id="stepActive_5" class="steps">
                    Other Information
                  </li>
                  <li id="stepActive_6" class="steps">Details of Residential</li>
                  
                  <li id="stepActive_7" class="steps">Upload Documents</li>
                  <li id="stepActive_19" class="steps">Acknowldgement</li>
                </ul>
                <div
                ...
                >
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="name_as_pan"
                          >1.PAN/TAN of Employer:<span class="text-danger">*</span></label
                        ><input
                          type="text"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="address"
                          >Document(s) required for proof of PAN/TAN :</label
                        >
                        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="principal_place_business"
                          >2. Name of the Employer (as mentioned in PAN/TAN):<span class="text-danger">*</span></label
                        >
                        <input
                          type="text"
                          class="form-control pri-form name_as_pan_cls"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Document(s) required for Constitution of Business*:</label>
                        <ul>
                  ...
                  <div class="col-md-6">
                    <div class="row justify-content-between align-items-center">
                      <div class="col-auto">
                        <label
                          >4. Nature of Work/Business/Activity (Mention
                          appropriate Sr. No. from) *:</label
                        >
                      </div>
                      <div class="col-auto">
                        <a href="javascript:void(0);">Annexure-II</a>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="name_as_pan"
                        >i) Serial No :<span class="text-danger">*</span></label
                      ><input
                        type="text"
                        class="form-control pri-form name_as_pan_cls"
                        id="name_as_pan"
                    ...
                    <div class="form-group">
                      <label for="name_as_pan"
                        >ii) In case of Serial Number-44 :<span
                          class="text-danger"
                          >*</span
                        ></label
                      ><input
                    ...
                    <div class="form-group">
                      <label
                        >5. Date of commencement of activity of Employer
                        *:</label
                      >
                      <input
                        type="date"
                    ...
                    <div class="form-group">
                      <label
                        >6. Commencement of liability, Month from which the
                        liability to pay tax commences*:</label
                      >
                      <label
                        >Mention the date on which liability to pay tax
                        commences:</label
                      >
                      <input
                        type="date"
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label
                        >7. No. of employees on the date of application to whom
                        salary or wages paid per month are *:</label
                      >
                      <div class="table-responsive">
                        <table class="table table-bordered text-center">
                          <thead>
                            <tr>
                              <th rowspan="6">Salary/Wages</th>
                              <th rowspan="6">No. of Employees</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td>
                                <h6>a) Do not exceed rupees 7,500/-</h6>
                              </td>
                              <td>
                                <input
                                  type="text"
                            ...
                            <tr>
                              <td>
                                <h6>
                                  b) Exceed rupees 7500/- but do not exceed
                                  rupees 10,000/-(for Male)
                                </h6>
                              </td>
                              <td>
                                <input
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="name_as_pan"
                        >8. Employer Member ID or PF Account Number* :<span
                          class="text-danger"
                          >*</span
                        ></label
                      ><input
                ...
                >
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group mandatory">
                        <label for="building_no"
                          >Building No/Flat No/Door No:</label
                        >
                        <input
                          type="text"
                          name="building_no"
                    ...
                    <div class="col-md-4">
                      <div class="form-group mandatory">
                        <label for="premises_name"
                          >Name of the Premises/Building:</label
                        >
                        <input
                          type="text"
                          name="premises_name"
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group mandatory">
                        <label for="telephone_no_1"
                          >Telephone No 1 with STD Code:</label
                        >
                        <div class="row">
                          <div class="col-4">
                            <input
                              type="text"
                              name="telephone_no_1_std"
                              id="telephone_no_1_std"
                              class="form-control"
                    ...
                    <div class="col-md-4">
                      <div class="form-group mandatory">
                        <label for="telephone_no_2"
                          >Telephone No 2 with STD Code:</label
                        >
                        <div class="row">
                          <div class="col-4">
                            <input
                              type="text"
                              name="telephone_no_2_std"
                              id="telephone_no_2_std"
                              class="form-control"
                              placeholder="STD Code"
                            />
                          </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group mandatory">
                        <label for="nature_of_possession"
                          >Nature of possession of premises:</label
                        >
                        <select
                        ...
                        >
                          ...
                          <option
                            value="Stall Booking (only applicable for casual dealers)"
                          >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="igr_sub_registrar"
                          >Location of Sub-registrar:</label
                        >
                        <select name="service_provider" id="service_provider" class="form-control pri-form">
                          <option value="">--Select--</option>
                        </select>
                  ...
                  <div class="text-center mt-3">
                    <button type="button" name="prevbtn3" id="prevbtn3" class="prevbtncls btn btn-info" data-id="2">
                      &lt;&lt;Prev</button>&nbsp;&nbsp;<button type="button" name="nextbtn3" id="nextbtn3" class="nextbtncls btn btn-primary" data-id="2">
                      Next&gt;&gt;
                    </button>
                  </div>
                </div>
                      ...
                      <div class="addMultipleFieldCls">
                        <div class="loopField_1 row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label
                                >Branch and Address of the Bank and
                                Branch:</label
                              >
                              <input
                                type="text"
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label>Document Required for bank details:</label
                              ><br />
                              <input
                                type="checkbox"
                                name="scanned_copy_cheque"
                              />
                              Scanned copy Cancelled Cheque of Current Account
                              in the name of firm/business
                            </div>
                          </div>
                        </div>
                      </div>
                      <input type="hidden" value="1" />
                      <a href="javascript:void(0);" class="add_more_button_cls"
                        >Add More</a
                      >
                    </div>
                  </div>
                ...
                >
                  <h2 class="form-sub-title">
                    11. Details of the Additional Place(s) of Business /
                    ...
                    <div class="addMultipleFieldCls">
                      <div class="loopField_1 row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select
                                name="additional_service_provider[]"
                                class="form-control pri-form"
                              >
                                <option value="">--Select--</option>
                              </select>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mandatory">
                              ...
                              <div class="row">
                                <div class="col-4">
                                  <input
                                    type="text"
                                    name="additional_telephone_no_1_std[]"
                                    class="form-control"
                                    placeholder="STD Code"
                                  />
                                </div>
                                <div class="col-8">
                                  <input
                                    type="text"
                                    name="additional_telephone_no_1[]"
                                    class="form-control"
                                  />
                                </div>
                              </div>
                            ...
                            <div class="form-group mandatory">
                              ...
                              <div class="row">
                                <div class="col-4">
                                  <input
                                    type="text"
                                    name="additional_telephone_no_2_std[]"
                                    class="form-control"
                                    placeholder="STD Code"
                                  />
                                </div>
                                <div class="col-8">
                                  <input
                                    type="text"
                                    name="additional_telephone_no_2[]"
                                    class="form-control"
                                  />
                                </div>
                              </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group mandatory">
                              <label for="email_address_1"
                                >Email Address 1:</label
                              >
                              <input
                                type="text"
                                name="additional_email_address_1[]"
                                class="form-control"
                              />
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input
                                type="text"
                                name="additional_email_address_2[]"
                                class="form-control"
                              />
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group mandatory">
                              ...
                              >
                              <select
                                name="additional_nature_of_possession[]"
                                class="form-control"
                              >
                                <option value="">--Select--</option>
                                <option value="Owned">Owned</option>
                        ...
                        <ul>
                          <li>
                            <input
                              type="checkbox"
                              name="additional_uploaded_documents[]"
                ...
                >
                  <div class="form-group">
                              <label>12. Employer Member ID or PF Account Number</label>
                              <input type="text" name="additional_floor_no[]" class="form-control pri-form">
                            </div>
                  <div class="form-group">
                              <label>13. Other information (If applicable)</label>
                ...
                >
                  <h2 class="form-sub-title">
                    10. Details of the Additional Place(s) of Business /
                    Godown(s) / Warehouse(s) in Maharashtra
                  </h2>
                  <br />
                  <div class="loopmailcls col-md-12">
                ...
                >
                  ...
                  <div class="form-group">
                    <label for="firm_name"
                      >Wholly:<span class="text-danger">*</span></label
                    >
                    <div class="row">
                      <div class="col-md-5">
                        <input
                  ...
                  <div class="form-group">
                    <label for="firm_name"
                      >Mainly:<span class="text-danger">*</span></label
                    >
                    <div class="row">
                      <div class="col-md-5">
                        <input
                  ...
                  <div class="form-group">
                    <label for="firm_name"
                      >Partley:<span class="text-danger">*</span></label
                    >
                    <div class="row">
                      <div class="col-md-5">
                        <input
                ...
                >
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="center_excise">Central Excise:</label>
                        <select
                          name="center_excise"
                          id="center_excise"
                          class="form-control"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="center_excise_val"><br /></label>
                        <input
                          type="text"
                          class="form-control"
                          id="center_excise_val"
                          placeholder=""
                          name="center_excise_val"
                        />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>IEC No.(importer exporter code number):</label>
                        <select name="eic_no" id="eic_no" class="form-control">
                          <option value="">--Select--</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="cst_no">VAT Registration No:</label>
                        <select name="cst_no" id="cst_no" class="form-control">
                          <option value="">--Select--</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="cin"
                          >Corporate Identity Number (CIN):</label
                        >
                        <select name="cin" id="cin" class="form-control">
                          <option value="">--Select--</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="ptrc">PTRC:</label>
                        <select name="ptrc" id="ptrc" class="form-control">
                          <option value="">--Select--</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="ptec">PTEC:</label>
                        <select name="ptec" id="ptec" class="form-control">
                          <option value="">--Select--</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                  ...
                  <div class="form-group col-md-6">
                    <h2 class="form-sub-title">13. We are members of:</h2>
                    <input
                      type="text"
                      name="additional_building_no[]"
                      class="form-control pri-form"
                ...
                >
                  ...
                  <div class="loopmailcls col-md-12">
                    <h2 class="form-sub-title mt-2">
                      <strong
                        >Any other documents on which the address is
                        available.</strong
                      >
                    </h2>
                    <div class="addMultipleFieldCls">
                      <div class="loopField_1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label
                                >OCI (Overseas Citizenship of India):</label
                              >
                              <input
                                type="text"
                                name="oci[]"
                ...
                >
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="mobile_no"
                          >15. Business in respect of which this application is
                          made, was first started on *:<span class="text-danger"
                            >*</span
                          ></label
                        ><input
                          type="date"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="mobile_no"
                          >16. The first sale in the course of inter-State was
                          effected on *:<span class="text-danger"
                            >*</span
                          ></label
                        ><input
                          type="date"
                  ...
                  <div class="row">
                    <p>
                    17. We observed the Name of the <input type="text" class="col-md-2 form-control pri-form name_as_pan_cls" id="name_as_pan" placeholder="Name of the Calendar" name="name_as_pan"> calendar and for
                    the purpose of accounts, our year runs from the(English
                    date) day (Indian date) day of<input type="date" name="declaration_date" class="form-control pri-form"> to the (English
                    date/Indian <input type="date" name="declaration_date" class="form-control pri-form"> date) day of
                  </p>
                  </div>
                  <label>18. The following goods or classes of goods are purchased by the dealer in the course of Inter-State Trade or Commerce for</label>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="firm_name">a. Resale:<span class="text-danger">*</span></label>
                      <div class="row">
                        <div class="col-md-10">
                          <input type="text" class="form-control pri-form" id="firm_name" placeholder="" name="firm_name" onkeyup="duplicateValue(this,'.firm_name_cls')">
                        </div>
                        <div class="col-md-2">
                  ...
                  <div class="form-group">
                      <label for="firm_name">
b. Use in Manufacture or processing of goods for sale:<span class="text-danger">*</span></label>
                      <div class="row">
                        <div class="col-md-10">
                          <input type="text" class="form-control pri-form" id="firm_name" placeholder="" name="firm_name" onkeyup="duplicateValue(this,'.firm_name_cls')">
                        </div>
                  ...
                  <div class="form-group">
                      <label for="firm_name">
d. Use in the generation or distribution of electricity or any other form of power:<span class="text-danger">*</span></label>
                      <div class="row">
                        <div class="col-md-10">
                          <input type="text" class="form-control pri-form" id="firm_name" placeholder="" name="firm_name" onkeyup="duplicateValue(this,'.firm_name_cls')">
                        </div>
                  ...
                  <div class="form-group">
                      <label for="firm_name">
e. Use in the packaging of goods for sale/resale:<span class="text-danger">*</span></label>
                      <div class="row">
                        <div class="col-md-10">
                          <input type="text" class="form-control pri-form" id="firm_name" placeholder="" name="firm_name" onkeyup="duplicateValue(this,'.firm_name_cls')">
                        </div>
...
19. We Manufacture, process of extract in mining the following classes of goods or generate or distribution the following form of power, namely:<span class="text-danger">*</span></label>
                      <div class="row">
                        <div class="col-md-11">
                          <input type="text" class="form-control pri-form" id="firm_name" placeholder="" name="firm_name" onkeyup="duplicateValue(this,'.firm_name_cls')">
                        </div>
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <input type="text" name="first_name[]" class="form-control pri-form" placeholder="First Name">
                                </div>
                                <div class="col-md-4">
                                  <input type="text" name="middle_name[]" class="form-control pri-form" placeholder="Middle Name">
                                </div>
                                <div class="col-md-4">
                                  <input type="text" name="last_name[]" class="form-control pri-form" placeholder="Last Name">
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                >
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label
                          >20(B) Status of the signatory to the
                          application:</label
                        >
                        <select
                ...
                >
                  <div class="col-md-12">
                    <h6>
                      1. Name of the person deemed to be the Manager/Authorized
                      Signatory in relation to the business of the dealer in the
                      State
                    </h6>
                    <br />
                    <div class="col-md-6">
                      ...
                      >
                        <div class="col-auto">
                          <label
                            >Details of Manager / Authorized Signatory</label
                          >
                        </div>
                        <div class="col-auto">
                          <a href="javascript:void(0);"
                            >Click here to fill Form 105</a
                          >
                        </div>
                      </div>
                    </div>
                    <br />
                    <h6>
                      2. The first sale in the course of inter-State was
                      effected on
                    </h6>
                    <div class="col-md-3">
                      <input
                ...
                >
                  <div class="col-md-12">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="name_as_pan">
                          1. Name of the applicant :<span class="text-danger"
                            >*</span
                          ></label
                        ><input
                          type="text"
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="name_as_pan"
                          >3. Registration Certificate Number under the MVAT
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="name_as_pan"
                          >4. Details of the person deemed to be the Manager/
                      ...
                      <div class="loopField_1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label
                                >5. Countersignature of the Person
                                Nominated:</label
                              >
                              <input
                                type="text"
                ...
                >
                  ...
                  <p>The Registering Authority,</p>
                  <p>
                    I hereby apply for grant of registration certificate under
                    section 5 of The Maharashtra State Tax on Professions,
                  ...
                  <div class="col-md-6">
                    <div class="row justify-content-between align-items-center">
                      <div class="col-auto">
                        <label
                          >1. Nature of Work/Business/Activity (Mention
                          appropriate Sr. No. from) *:</label
                        >
                      </div>
                      <div class="col-auto">
                    ...
                    <div class="form-group">
                      <label
                        >2. Date of commencement of activity of Employer
                        *:</label
                      >
                      <input
                        type="date"
                    ...
                    <div class="form-group">
                      <label
                        >3. Commencement of liability, Month from which the
                        liability to pay tax commences*:</label
                      >
                      <label
                        >Mention the date on which liability to pay tax
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label
                        >4. No. of employees on the date of application to whom
                        salary or wages paid per month are *:</label
                      >
                      <div class="table-responsive">
                        <table class="table table-bordered text-center">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="name_as_pan"
                        >5. Employer Member ID or PF Account Number* :<span
                          class="text-danger"
                          >*</span
                        ></label
                      ><input
                ...
                >
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>2. (a) Type of the Applicant:*</label>
                      <div class="row">
                        <div class="col-6">
                          <input
                            type="radio"
                            ...
                            checked
                          />
                          i. Firm / Company / Trust / Society / Institution..
                          etc
                        </div>
                        <div class="col-6">
                          <input
                    ...
                    <label
                      >2. (b) Name of the Applicant (Based on above selected
                      options):*</label
                    >
                    ...
                    <div id="form1">
                      <div class="form-group">
                        <label
                          >i. Firm/Company/Trust/Society/Institution etc.
                          M/s</label
                        >
                    ...
                    <div id="form2" style="display: none">
                      <div class="form-group">
                        <label>ii. In case of an individual person:*</label>
                        <div class="row">
                          <div class="col-4">
                            <input
                              type="text"
                  ...
                  <div
                    class="col-md-6 row justify-content-between align-items-center"
                  >
                    <div class="col-auto">
                      <label
                        >4. Entry No. under Schedule I to the Profession Tax
                        Act, 1975:*</label
                      >
                    </div>
                    <div class="col-auto">
                      <a href="javascript:void(0);">Annexure-I</a>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Entry:*</label>
                      <input type="text" class="form-control pri-form" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label
                        >5 (A). Registration No. with
                        Council/Body/Association/Corporation/Government:</label
                      >
                      <input type="text" class="form-control pri-form" />
                    </div>
                    <div class="form-group">
                      <label
                        >5 (B). Month of Commencement of the
                        Profession/Trade/Calling/Employment:*</label
                      >
                      <input type="date" class="form-control" />
                    </div>
                  </div>
                  ...
                  <script>
                    function showForm(formId) {
                      document.getElementById("form1").style.display =
                        formId === "form1" ? "block" : "none";
                      document.getElementById("form2").style.display =
                        formId === "form2" ? "block" : "none";
                    }
                  </script>
                  ...
                  <div class="form-group">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered text-center">
                        <thead>
                          <tr>
                            <th rowspan="3">Entry No.</th>
                            <th rowspan="3">Sub-Entry No.</th>
                            <th rowspan="3">Particulars</th>
                            <th rowspan="3">Annexure</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                ...
                >
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div
                        class="row align-items-center mb-3 justify-content-between"
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >Annexure "B" (Download Template)</label
                          >
                        </div>
                        <div class="col-auto">
                          <button
                            class="btn custom-download-btn d-flex align-items-center"
                          >
                            <i class="bi bi-download me-2"></i>
                            <span>Download</span>
                          </button>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >Photo of signatory to the application*</label
                          >
                        </div>
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >Month wise Purchase and Sales Summary and bill wise
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >Sale Bill/Purchase Bill (in cases where Purchase
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >Lorry/Transport receipt of purchase of imported
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >POB-Latest electricity bill*</label
                          >
                        </div>
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >BANK-000001-Cancelled cheque(s) of current account
                      ...
                      >
                        <div class="col-auto">
                          <label class="mb-0"
                            >APOB-000001-Latest electricity bill*</label
                          >
                        </div>
