        ...
        <h1>PTEC Registration</h1>
              ...
              >
                <ul id="progressbar">
                  ...
                  <li id="stepActive_2" class="steps">Full Address</li>
                  <li id="stepActive_3" class="steps">POB</li>
                  <li id="stepActive_4" class="steps">Bank Details</li>
                  <li id="stepActive_5" class="steps">
                    Schedule Entry
                  </li>
                  <li id="stepActive_6" class="steps">Other Information</li>
                ...
                >
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      <label for="city">1.(A) PAN/TAN:</label>
                      <input type="text" class="form-control pri-form citycls" id="city" placeholder="" name="city" onkeyup="duplicateValue(this,'.proprietor_village_cls, .presnt_proprietor_village, .additional_business_village_cls')">
                    </div>
                  </div>

                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="phone_no">(B) Name as shown in PAN/TAN:<span class="text-danger">*</span></label>
                        <input type="text" class="form-control pri-form phone_no_cls" id="phone_no" placeholder="" name="phone_no" onkeyup="duplicateValue(this,'.additional_business_telephone_no_cls')">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                >
                  <h2 class="form-sub-title">
                    6.Full address of the applicant (Residential) *:
