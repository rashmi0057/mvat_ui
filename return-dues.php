          ...
          <table class="table table-bordered text-center" id="commodity-table">
            <thead>
              <tr>
                ...
                <th rowspan="2">Tax</th>
                <th rowspan="2">Calculated Interest</th>
                <th rowspan="2">Late Fees</th>
                <th rowspan="2">Total</th>
                <th rowspan="2">Tax to be Paid</th>
                <th rowspan="2">Interest to be Paid</th>
                <th rowspan="2">Late Fees to be Paid</th>
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" class="form-control pri-form" name="sub_entry[]" readOnly></td>
                <td><input type="text" class="form-control pri-form" name="sub_entry[]" readOnly></td>
                <td><a type="button" href="payment-gateway.php" class="btn btn-success deleteTr">Pay</a></td>
